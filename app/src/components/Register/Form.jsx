  ...
  return (
      ...
      >
        ...
        >
          {({ formProps, submitting }) => (
            <form style={{ width: "400px" }} {...formProps}>
              <FormHeader title="Inscrivez-vous à Eden" />
                  ...
                  >
                    <Field name="sexe" label="Genre">
                      {({ fieldProps: { id, ...rest }, error }) => (
                        <Fragment>
                          <Select inputId={id} options={genders} isClearable />
                          {error && <ErrorMessage>{error}</ErrorMessage>}
                        </Fragment>
                      )}
                    </Field>
                    ...
                    <Field name="dateOfBirth" label="Date de naissance">
                      {({ fieldProps: { id, ...rest }, error }) => (
                        <Fragment>
                          <div
                            id="dateDeNaissance"
   ...
   >
            ...
            <option value="1980">1980</option>
                    ...
                    <Field name="adresse" label="Adresse de résidance">
                      {({ fieldProps: { id, ...rest }, error }) => (
                        <Fragment>
                          <TextField type="text" />
                          {error && <ErrorMessage>{error}</ErrorMessage>}
